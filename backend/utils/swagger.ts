...
const swaggerSpec = {
    ...
    paths: {
        ...
        '/stream/token': {
            get: {
                summary: 'Get a Stream user token',
                tags: ['Stream'],
                responses: {
                    200: {
        ...
        '/stream/call-type': {
            post: {
                summary: 'Initialize a Stream call type',
                tags: ['Stream'],
                responses: {
                    200: {
                        description: 'Call initialized',
                        content: {
                            'application/json': {
                                schema: {
                                    type: 'object',
        ...
        '/meetings': {
            post: {
                summary: 'Create a family meeting',
                tags: ['Meetings'],
                requestBody: {
                    required: true,
                    content: {
                        'application/json': {
                            schema: {
                                ...
                                required: ['title'],
                                properties: {
                                    title: { type: 'string', example: 'Monthly Family Meeting' },
                                    description: { type: 'string' },
                                    type: { type: 'string', enum: ['family_meeting', 'instant_call', 'scheduled'] },
